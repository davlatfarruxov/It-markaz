        ...
        <div class="full-width-header header-style2 modify1">
            ...
            <header id="rs-header" class="rs-header">
                ...
                <!-- Menu Start -->
                <div class="menu-area menu-sticky" id="div1">
                            ...
                            <div class="col-lg-4">
                                <div class="logo-cat-wrap">
                                    <div class="logo-part pr-90">
                                        <a href="index.html">
                                            <h1 class="text-white">IT MARKAZ</h1>
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-8 text-center">
                                <div class="rs-menu-area">
                                    <div class="main-menu pr-90 md-pr-15">
                                        ...
                                        <nav class="rs-menu">
                                           <ul class="nav-menu">
                                              <li class="rs-mega-menu mega-rs menu-item-has-children current-menu-item"> <a href="index.php">Bosh sahifa</a>
                                              </li>
                                               <li class="menu-item-has-children">
                                                   <a href="#rs-about">Biz Haqimizda</a>
                                               </li>
                ...
                <nav class="right_menu_togle hidden-md">
                    ...
                    <div class="canvas-logo">
                        <a href="index.html"><h2>IT Markaz</h2></a>
                    </div>
                    <div class="offcanvas-text">
                        <p>Samarqand Davlat Universiteti tomonidan tashkil etilgan, zamonaviy kasblarni o'rganishga ixtisoslashtirilgan markaz.</p>
                    </div>
                    ...
                    <div class="map-img">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3072.505052027064!2d66.96663537656569!3d39.63834680264534!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3f4d1f9b3f6ec5e7%3A0x9c277e606f80b7d7!2sAmaliy%20Matematika%20Fakulteti!5e0!3m2!1sru!2s!4v1681900427426!5m2!1sru!2s" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
